...
<html>
	<head>
		<meta charset="utf8">
		<title>Inscription point relais</title>
    ...
    <div class="site-section" >
		<div class="formulaire">
			<form class="border border-light p-5" method="POST" action="enregistrer.php">
				...
				<div class="form-row">
					<div class="form-group col-md-6">
						<label for="inputActivite">Activite de l'entreprise<b class="obligatoire">*</b></label>
						<select class="form-control" name="activite" id="inputActivite" size=1 required>
					...
					<div class="form-group col-md-6">
						<label for="inputNomEntreprise">Nom de l'entreprise<b class="obligatoire">*</b></label>
						<input class="form-control" id="inputNomEntreprise" name="nomEntreprise" placeholder="Nom de votre entreprise" type="text" onkeyup="verifChamp(inputNomEntreprise)" minlength="4" maxlength="30" required>
						<span id="alertNomEntreprise"></span>
					</div>
				</div>
				<div class="form-group">
				...
				<button class="btn btn-info my-4 btn-block" value="Valider" onclick="validerInscription()" type="submit" name="validerPointRelais" id="submitButton">S'inscrire</button>
				<p>
					                En cliquant sur
					<em>Valider</em>
					                 vous adhérez à nos
    ...
    <script src="assets/js/script_pR.js"></script>
</html>
