...
<html>
	...
	<body class="bg">
		...
		<div class="formulaire">
			<form class="border border-light p-5" method="POST" action="enregistrer.php">
				...
				<button class="btn btn-info my-4 btn-block" value="Valider" onclick="validerInscription()" type="submit" name="validerClient" id="submitButton">S'inscrire</button>
				<p>
					                En cliquant sur
					<em>Valider</em>
					                 vous adhérez à nos
    ...
    <script src="assets/js/script_cli.js"></script>
</html>
